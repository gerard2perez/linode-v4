...
|await server.account.creditCard({} as CreditCard) | [/account](https://developers.linode.com/api/v4#operation/createCreditCard)|
...
|await server.linode.instances(1).reboot() | [/linode/instances/{linodeId}](https://developers.linode.com/api/v4#operation/rebootLinodeInstance)|
