...
|await server.account.creditCard({} as CreditCard)	}) | [/account/credit-card](https://developers.linode.com/api/v4#operation/createCreditCard) |
|await server.account.transfer()	}) | [/account/transfer](https://developers.linode.com/api/v4#operation/getTransfer) |
...
|await server.account.events(1).read()	}) | [/account/events/{eventId}/read](https://developers.linode.com/api/v4#operation/eventRead) |
|await server.account.events(1).seen()	}) | [/account/events/{eventId}/seen](https://developers.linode.com/api/v4#operation/eventSeen) |
...
|await server.account.oauthClients('clientId').resetSecret()	}) | [/account/oauth-clients/{clientId}/reset-secret](https://developers.linode.com/api/v4#operation/resetClientSecret) |
...
|await server.account.payments.paypal.execute({} as PayPalExecute)	}) | [/account/payments/paypal/execute](https://developers.linode.com/api/v4#operation/executePayPalPayment) |
...
|await server.domains(1).records.create({} as DomainRecord)	}) | [/domains/{domainId}/records](https://developers.linode.com/api/v4#operation/createDomainRecord) |
...
|await server.linode.instances(1).boot({} as any)	}) | [/linode/instances/{linodeId}/boot](https://developers.linode.com/api/v4#operation/bootLinodeInstance) |
|await server.linode.instances(1).clone({} as any)	}) | [/linode/instances/{linodeId}/clone](https://developers.linode.com/api/v4#operation/cloneLinodeInstance) |
|await server.linode.instances(1).mutate()	}) | [/linode/instances/{linodeId}/mutate](https://developers.linode.com/api/v4#operation/mutateLinodeInstance) |
|await server.linode.instances(1).reboot()	}) | [/linode/instances/{linodeId}/reboot](https://developers.linode.com/api/v4#operation/rebootLinodeInstance) |
|await server.linode.instances(1).rebuild({} as any)	}) | [/linode/instances/{linodeId}/rebuild](https://developers.linode.com/api/v4#operation/rebuildLinodeInstance) |
|await server.linode.instances(1).rescue({} as any)	}) | [/linode/instances/{linodeId}/rescue](https://developers.linode.com/api/v4#operation/rescueLinodeInstance) |
|await server.linode.instances(1).resize({} as any)	}) | [/linode/instances/{linodeId}/resize](https://developers.linode.com/api/v4#operation/resizeLinodeInstance) |
|await server.linode.instances(1).shutdown()	}) | [/linode/instances/{linodeId}/shutdown](https://developers.linode.com/api/v4#operation/shutdownLinodeInstance) |
...
|await server.linode.instances(1).backups.cancel()	}) | [/linode/instances/{linodeId}/backups/cancel](https://developers.linode.com/api/v4#operation/cancelBackups) |
|await server.linode.instances(1).backups.enable()	}) | [/linode/instances/{linodeId}/backups/enable](https://developers.linode.com/api/v4#operation/enableBackups) |
...
|await server.linode.instances(1).backups(1).restore({} as any)	}) | [/linode/instances/{linodeId}/backups/{backupId}/restore](https://developers.linode.com/api/v4#operation/restoreBackup) |
...
|await server.linode.instances(1).disks(1).password({} as any)	}) | [/linode/instances/{linodeId}/disks/{diskId}/password](https://developers.linode.com/api/v4#operation/resetDiskPassword) |
|await server.linode.instances(1).disks(1).resize({} as any)	}) | [/linode/instances/{linodeId}/disks/{diskId}/resize](https://developers.linode.com/api/v4#operation/resizeDisk) |
...
|await server.linode.instances(1).stats.stats(1, 1)	}) | [/linode/instances/{linodeId}/stats/{year}/{month}](https://developers.linode.com/api/v4#operation/getLinodeStatsByYearMonth) |
...
|await server.linode.stackscripts.create({} as StackScript)	}) | [/linode/stackscripts](https://developers.linode.com/api/v4#operation/addStackScript) |
...
|await server.managed.credentials(1).revoke()	}) | [/managed/credentials/{credentialId}/revoke](https://developers.linode.com/api/v4#operation/deleteManagedCredential) |
...
|await server.managed.services(1).disable()	}) | [/managed/services/{serviceId}/disable](https://developers.linode.com/api/v4#operation/disableManagedService) |
|await server.managed.services(1).enable()	}) | [/managed/services/{serviceId}/enable](https://developers.linode.com/api/v4#operation/enableManagedService) |
### networking
|Command|API Reference|
|---|---|
...
|await server.networking.ipv4.assign({} as any)	}) | [/networking/ipv4/assign](https://developers.linode.com/api/v4#operation/assignIPs) |
|await server.networking.ipv4.share({} as any)	}) | [/networking/ipv4/share](https://developers.linode.com/api/v4#operation/shareIPs) |
...
|await server.profile.grants()	}) | [/profile/grants](https://developers.linode.com/api/v4#operation/getProfileGrants) |
|await server.profile.tfaDisable()	}) | [/profile/tfa-disable](https://developers.linode.com/api/v4#operation/tfaDisable) |
|await server.profile.tfaEnable()	}) | [/profile/tfa-enable](https://developers.linode.com/api/v4#operation/tfaEnable) |
|await server.profile.tfaEnableConfirm({} as any)	}) | [/profile/tfa-enable-confirm](https://developers.linode.com/api/v4#operation/tfaConfirm) |
...
|await server.support.tickets(1).attachments()	}) | [/support/tickets/{ticketId}/attachments](https://developers.linode.com/api/v4#operation/createTicketAttachment) |
...
|await server.volumes(1).attach({} as any)	}) | [/volumes/{volumeId}/attach](https://developers.linode.com/api/v4#operation/attachVolume) |
|await server.volumes(1).clone({} as any)	}) | [/volumes/{volumeId}/clone](https://developers.linode.com/api/v4#operation/cloneVolume) |
|await server.volumes(1).detach()	}) | [/volumes/{volumeId}/detach](https://developers.linode.com/api/v4#operation/detachVolume) |
|await server.volumes(1).resize({} as any)	}) | [/volumes/{volumeId}/resize](https://developers.linode.com/api/v4#operation/resizeVolume) |
