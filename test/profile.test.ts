...
describe('/profile', () => {
	...
	it('ssh_keys', async ()=>{
		...
		expect(await server.profile.sshkeys.list({} as Filter<PersonalAccessTokenFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/sshkeys","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.sshkeys.list(2, {} as Filter<PersonalAccessTokenFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/sshkeys","query":"?page=2","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.sshkeys.list(2, 5, {} as Filter<PersonalAccessTokenFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/sshkeys","query":"?page=2&page_size=5","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.sshkeys.create({} as any)).to.deep.equal({"verb":"post","route":"https://api.linode.com/v4/profile/sshkeys","body":{},"headers":{"Authorization":"Bearer personal-key-secured"}});
		...
		expect(await server.profile.sshkeys(1).update({} as PersonalAccessToken)).to.deep.equal({"verb":"put","route":"https://api.linode.com/v4/profile/sshkeys/1","body":{},"headers":{"Authorization":"Bearer personal-key-secured"}});
	...
	it('devices', async ()=>{
		...
		expect(await server.profile.devices.list({} as Filter<UserFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/devices","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.devices.list(2, {} as Filter<UserFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/devices","query":"?page=2","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.devices.list(2, 5, {} as Filter<UserFilter>)).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/devices","query":"?page=2&page_size=5","headers":{"Authorization":"Bearer personal-key-secured","X-Filter":{}}});
		expect(await server.profile.devices('deviceId').get()).to.deep.equal({"verb":"get","route":"https://api.linode.com/v4/profile/devices/deviceId","headers":{"Authorization":"Bearer personal-key-secured"}});
		expect(await server.profile.devices('deviceId').delete()).to.deep.equal({"verb":"delete","route":"https://api.linode.com/v4/profile/devices/deviceId","headers":{"Authorization":"Bearer personal-key-secured"}});
	});
});
