...
describe('/domains', () => {
	...
	it('domains', async ()=>{
		...
		expect(await server.domains(1).records.create({} as DomainRecord)).to.deep.equal({"verb":"post","route":"https://api.linode.com/v4/domains/1/records","body":{},"headers":{"Authorization":"Bearer personal-key-secured"}});
